...
from ..protocol import ControlFrame, ControlInput, ControlSignal, VideoFrame
...
class DummyRobotAdapter(AdamasRobotAdapter):
    ...
    def __init__(self, config: RobotConfig) -> None:
        ...
        self.front_camera = self.add_video("front_camera")
        self.robot_state = self.add_telemetry("robot_state")
    ...
    def _apply_frame(self, frame: ControlFrame) -> None:
        ...
        self._last_command_us = time.time_ns() // 1_000
